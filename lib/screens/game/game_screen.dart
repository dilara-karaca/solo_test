...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  List<List<bool>> _emptyMoves() {
    ...
    return List.generate(boardSize, (i) => List.generate(boardSize, (j) => false));
  }
  ...
  void _showGameOverDialog() {
    ...
    final avatar = AppConstants.getAvatarForRemainingPieces(result.remainingPieces);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('OYUN BİTTİ',
                    style: TextStyle(color: theme.textPrimary, fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: 5)),
                  const SizedBox(height: 6),
                  Text(result.grade, style: TextStyle(color: theme.primaryLight, fontSize: 14)),
                  const SizedBox(height: 24),
                  _DialogStat(label: 'Puan', value: result.score.toString(), color: theme.accentColor, theme: theme),
                  const SizedBox(height: 8),
                  _DialogStat(label: 'Kalan Piyon', value: result.remainingPieces.toString(), color: theme.primaryLight, theme: theme),
                  const SizedBox(height: 8),
                  _DialogStat(label: 'Toplam Hamle', value: result.totalMoves.toString(), color: theme.accentColor, theme: theme),
                  ...
                  SizedBox(
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(colors: [theme.primaryColor, theme.primaryDark]),
                        boxShadow: [BoxShadow(color: theme.primaryColor.withOpacity(0.35), blurRadius: 14, offset: const Offset(0, 6))],
                      ),
                  ...
                  SizedBox(
                    ...
                    child: TextButton.icon(
                      ...
                      icon: Icon(Icons.home_outlined, color: theme.textSecondary, size: 18),
                      label: Text('ANA MENÜ', style: TextStyle(color: theme.textSecondary, letterSpacing: 2, fontSize: 13)),
                    ),
                  ),
                ],
              ),
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      _BarButton(icon: Icons.arrow_back_ios_new_rounded, onPressed: () => Navigator.pop(context), theme: theme),
                      Expanded(
                        child: Center(
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              ...
                              Text(theme.name,
                                style: TextStyle(color: theme.textPrimary, fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 4)),
                            ],
                          ),
                        ),
                      ),
                      _BarButton(
                        ...
                        onPressed: gameEngine.moveHistory.isEmpty ? null : () {
                          setState(() {
                    ...
                    children: [
                      Expanded(
                        child: _InfoCard(
                          ...
                          emojiIcon: theme.useAssetPiece ? theme.pieceEmoji : null,
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(label,
                style: TextStyle(color: theme.textSecondary, fontSize: 10, letterSpacing: 0.5)),
            ],
          ),
        ],
      ),
...
class _DialogStat extends StatelessWidget {
  ...
  const _DialogStat({required this.label, required this.value, required this.color, required this.theme});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: AppTextStyles.bodySmall.copyWith(color: theme.textSecondary)),
